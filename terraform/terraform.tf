...
/*resource "digitalocean_droplet" "coreos-2" {
    image = "coreos-stable"
    name = "core-2"
    region = "ams3"
    size = "512mb"
...
coreos:
  etcd:
    discovery: https://discovery.etcd.io/4911adcd842ee96f5575a602c9926514
    addr: $private_ipv4:4001
    peer-addr: $private_ipv4:7001
  fleet:
    public-ip: $private_ipv4
...
output "core-2.ipv4_address" {
	value = "${digitalocean_droplet.coreos-2.ipv4_address}"
}*/
